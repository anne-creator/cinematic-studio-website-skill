# Original Prisma Landing-Page Prompt

This is the source prompt supplied with the skill. Use it as a visual and interaction reference. Personalize all names, factual claims, copy, CTAs, and media for the current user.
